...
declare const Position: import("../../core/kinds").Kinds.Or<["bottom" | "bottom_center" | "bottom_left" | "bottom_right" | "center" | "center_center" | "center_left" | "center_right" | "left" | "right" | "top" | "top_center" | "top_left" | "top_right", [string | number | [string, string] | [string, string, string], string | number | [string, string] | [string, string, string]]]>;
type Position = typeof Position["__type__"];
declare const PositionUnits: import("../../core/kinds").Kinds.Enum<"data" | "percent" | "screen" | "view">;
type PositionUnits = typeof PositionUnits["__type__"];
declare const LengthUnits: import("../../core/kinds").Kinds.Enum<"data" | "percent" | "screen">;
