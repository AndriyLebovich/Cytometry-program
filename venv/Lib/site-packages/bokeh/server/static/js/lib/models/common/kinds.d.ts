...
export declare const HAnchor: import("../../core/kinds").Kinds.Or<["center" | "end" | "start", "center" | "left" | "right", number]>;
export type HAnchor = typeof HAnchor["__type__"];
export declare const VAnchor: import("../../core/kinds").Kinds.Or<["center" | "end" | "start", "bottom" | "center" | "top", number]>;
export type VAnchor = typeof VAnchor["__type__"];
export declare const Anchor: import("../../core/kinds").Kinds.Or<["bottom" | "bottom_center" | "bottom_left" | "bottom_right" | "center" | "center_center" | "center_left" | "center_right" | "left" | "right" | "top" | "top_center" | "top_left" | "top_right", [number | "center" | "end" | "left" | "right" | "start", number | "bottom" | "center" | "end" | "start" | "top"]]>;
export type Anchor = typeof Anchor["__type__"];
export declare const AutoAnchor: import("../../core/kinds").Kinds.Or<["auto", "bottom" | "bottom_center" | "bottom_left" | "bottom_right" | "center" | "center_center" | "center_left" | "center_right" | "left" | "right" | "top" | "top_center" | "top_left" | "top_right", [number | "auto" | "center" | "end" | "left" | "right" | "start", number | "auto" | "bottom" | "center" | "end" | "start" | "top"]]>;
export type AutoAnchor = typeof AutoAnchor["__type__"];
export declare const TextAnchor: import("../../core/kinds").Kinds.Or<["bottom" | "bottom_center" | "bottom_left" | "bottom_right" | "center" | "center_center" | "center_left" | "center_right" | "left" | "right" | "top" | "top_center" | "top_left" | "top_right" | [number | "center" | "end" | "left" | "right" | "start", number | "bottom" | "center" | "end" | "start" | "top"], "auto"]>;
...
export declare const TrackAlign: import("../../core/kinds").Kinds.Enum<"auto" | "center" | "end" | "start">;
...
export declare const IconLike: import("../../core/kinds").Kinds.Or<["append_mode" | "arrow_down_to_bar" | "arrow_up_from_bar" | "auto_box_zoom" | "bold" | "box_edit" | "box_select" | "box_zoom" | "caret_down" | "caret_left" | "caret_right" | "caret_up" | "check" | "chevron_down" | "chevron_left" | "chevron_right" | "chevron_up" | "clear_selection" | "copy" | "crosshair" | "dark_theme" | "delete" | "freehand_draw" | "fullscreen" | "help" | "hover" | "intersect_mode" | "invert_selection" | "italic" | "lasso_select" | "light_theme" | "line_edit" | "maximize" | "minimize" | "pan" | "pin" | "point_draw" | "pointer" | "poly_draw" | "poly_edit" | "polygon_select" | "range" | "redo" | "replace_mode" | "reset" | "save" | "see_off" | "see_on" | "settings" | "square" | "square_check" | "subtract_mode" | "tap_select" | "text_align_center" | "text_align_left" | "text_align_right" | "undo" | "unknown" | "unpin" | "wheel_pan" | "wheel_zoom" | "x_box_select" | "x_box_zoom" | "x_grip" | "x_pan" | "xor_mode" | "y_box_select" | "y_box_zoom" | "y_grip" | "y_pan" | "zoom_in" | "zoom_out", `--${string}`, `.${string}`, `data:image${string}`]>;
